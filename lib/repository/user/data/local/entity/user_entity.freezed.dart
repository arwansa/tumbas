...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, username: $username, password: $password, email: $email, firstName: $firstName, lastName: $lastName, gender: $gender, image: $image, token: $token)';
  }
...
abstract class _UserEntity implements UserEntity {
  factory _UserEntity(
      ...
      final String gender,
      final String image,
      final String token}) = _$_UserEntity;
